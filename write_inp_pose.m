function res = write_inp_pose(X3d,avgCarHeight,avgCarWidth,avgCarLength,K,kps,meanshape,vectors,theta2,kp_lookup)

    fID = fopen('Ceres/ceres_input_singleViewPoseAdjuster.txt','w');
