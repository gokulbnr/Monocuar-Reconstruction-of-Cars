...
int main(int argc, char** argv){
	...
	// ceres::CostFunction *normalAlignment = new ceres::AutoDiffCostFunction<NormalAlignment, 1, 3, 3>(
	// 	new NormalAlignment(nvc,d,tc));
	// problem.AddResidualBlock(normalAlignment, new ceres::HuberLoss(0.8),rotAngleAxis,trans);

	// // Ground Plane Estimation 
	// ceres::CostFunction *groundPlaneEstimation = new ceres::AutoDiffCostFunction<GroundPlaneEstimation, 1, 3, 3>(
	// 	new GroundPlaneEstimation(nvc,d,tc));
	// problem.AddResidualBlock(groundPlaneEstimation, new ceres::HuberLoss(50),rotAngleAxis,trans);
